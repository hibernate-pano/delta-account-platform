                ...
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-left transition-all ${
                    activeSection === item.id
                      ...
                      : 'text-slate-400 hover:text-white hover:bg-dark-lighter hover:scale-[1.02] active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-dark'
                  }`}
                >
                    ...
                    <button
                      ...
                      className={`w-full flex items-center gap-2 px-2.5 py-1.5 rounded-lg text-sm text-left transition-all ${
                        activeSection === item.id
                          ...
                          : 'text-slate-500 hover:text-white hover:bg-dark-lighter hover:translate-x-1 hover:scale-[1.02] active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-dark'
                      }`}
                    >
