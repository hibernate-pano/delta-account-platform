...
import {
  ...
  Shield, User, Star, Search, TrendingUp, TrendingDown, Sparkles, ShieldCheck, Sword
} from 'lucide-react';
          ...
          <div className="flex items-center gap-4 bg-dark rounded-xl p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1 text-xs text-slate-500">
                ...
                {order.account?.weapons && <span className="flex items-center gap-1"><Sword className="w-3 h-3 text-rose-400/70" /> {order.account.weapons.length > 6 ? `${order.account.weapons.slice(0, 6)}…` : order.account.weapons}</span>}
              </div>
            </div>
