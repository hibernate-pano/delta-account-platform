            ...
            <div className="px-3 pt-2">
              ...
              {['账号还在吗？', '可以便宜一点吗？', '什么时候交易？', '加我私聊'].map((tpl) => (
                <button
                  ...
                  className="flex-shrink-0 px-3 py-1.5 text-xs rounded-full bg-dark-lighter text-slate-400 border border-dark-border hover:border-primary/50 hover:text-white active:scale-95 active:bg-primary/20 active:border-primary/50 active:text-white transition-all duration-150 whitespace-nowrap"
                >
                  {tpl}
                </button>
              ))}
