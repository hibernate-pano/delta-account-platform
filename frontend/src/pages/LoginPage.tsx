          ...
          {loginTab === 'manual' ? (
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button type="button" className="flex items-center justify-center gap-2 py-3 bg-dark-lighter hover:bg-slate-700/50 border border-slate-700/50 hover:border-slate-600 rounded-xl text-sm text-slate-400 hover:text-white transition-all">
